<template>
  <div>
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="updateCart('reduce',item)">-</a>
                        <span class="select-ipt">{{item.productNum}}</span>
                        <a class="input-add" @click="updateCart('add',item)">+</a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;">
                  <span class="checkbox-btn item-check-btn" @click="checkAll" v-bind:class="{checked:checkAllFlag}">
    ...
    <modal v-bind:mdShow="mdShowDel" v-on:close="closeModal">
      ...
      <div slot="btnGroup">
        <el-button type="primary" @click="delCart">确认</el-button>
...
<script>
  ...
  export default{
    ...
    computed:{ //实时计算选中数量决定checkAllFlag是否为true
      checkAllFlag(){
      ...
      totalPrice(){
        ...
        this.cartList.forEach((item)=>{
          if(item.checked=='1'){
            i+=item.productNum*item.salePrice
          }
        });
        return i;
      },
