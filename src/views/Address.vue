<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" v-bind:class="{check:chooseIndex==index}" @click="chooseIndex=index;selectAddressId=item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-del">
                    <a href="javascript:;" class="addr-del-btn" @click='cofirmDelAddress(item.addressId)'>
                      <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                    </a>
                  </div>
                  <div class="addr-opration addr-set-default" v-if="!item.isDefault">
                    <a href="javascript:;" class="addr-set-default-btn"><i @click="setDefault(item.addressId)">Set default</i></a>
                  </div>
    ...
    <modal v-bind:mdShow="mdShow" v-on:close="closeModal">
      ...
      <div slot="btnGroup">
        <el-button type="primary" @click="delAddress(addressId)">确认</el-button>
        <el-button type="primary" plain @click="mdShowDel=false">取消</el-button>
...
<script>
  ...
  export default {
    ...
    computed: {
      addressListFilter(){
          var filterList=this.addressList.slice(0,this.limit);
